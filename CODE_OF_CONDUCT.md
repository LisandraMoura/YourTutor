...
Ocorrências de comportamentos abusivos, de assédio ou que sejam inaceitáveis por qualquer outro motivo poderão ser reportadas para a liderança da comunidade, responsável pela aplicação, via contato pelos canais privados do próprio GitHub, descritos em [Como reportar](#como-reportar). Todas as reclamações serão revisadas e investigadas imediatamente e de maneira justa.
...
Use os canais privados do próprio GitHub. Nenhum deles é público:

- **[Reportar abuso](https://github.com/contact/report-abuse)** — formulário do GitHub para
  denunciar conteúdo ou comportamento abusivo.
- **Report content** — mesma denúncia, feita direto no menu `...` de qualquer issue, pull
  request, comentário ou perfil.

**Nunca relate um incidente de conduta em issue ou comentário público.** Além de expor quem
está envolvido, uma denúncia pública dificulta a apuração.

Quem reporta tem a privacidade respeitada, conforme a seção **Aplicação**.

---

## Sobre este documento

Este é o Contributor Covenant 2.1 na tradução oficial em português do Brasil, sem
alterações no texto além do canal de contato indicado na seção **Aplicação**.

A mantenedora do projeto é [@LisandraMoura](https://github.com/LisandraMoura).

**Vulnerabilidade de segurança não é assunto deste documento** — o procedimento de
reporte privado está no [`SECURITY.md`](SECURITY.md).
